      ...
      <div className="bg-[#FFF8F5] py-16">
        <div className="container mx-auto px-4  py-10 flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left m-10">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#111430] leading-tight delay-appear mb-4">
              BEAUTY SALON <br /> FOR EVERY WOMEN
            </h1>
            <p className="text-gray-600 mb-6 delay-appear">
            ...
            <button className="bg-pink-500 hover:bg-pink-600 transition delay-appear text-white px-6 py-3 rounded-md font-medium">
              Book Our Services
            </button>
          </div>
